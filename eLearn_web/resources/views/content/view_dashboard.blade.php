                ...
                <div class="col-lg-8">
                    ...
                    <div class="card card-custom bg-gray-100 card-stretch gutter-b">
                        ...
                        <div class="card-header border-0 bg-danger py-5">
                            <h3 class="card-title font-weight-bolder text-white">Aqui estão alguns dados dos últimos dias</h3>
                            <div class="text-white">Uma plataforma completa onde você pode acompanhar a evolução de seu negócio quando você quiser e na hora em você.</div>
                            ...
                            <div class="card-spacer mt-n25">
                                ...
                                <div class="row m-0">
                                    {{-- <div class="col bg-light-warning px-6 py-8 rounded-xl mr-7 mb-7">
                                        ...
                                        <a href="#" class="text-warning font-weight-bold font-size-h6">Vendas Semanais</a>
                                    </div> --}}
                                    <div class="col bg-light-primary px-6 py-8 rounded-xl mb-7">
                                        ...
                                        <a href="#" class="text-primary font-weight-bold font-size-h6 mt-2"><b>{{$count_user}}</b> Usuários</a>
                                    </div>
                                </div>
                                <!--end::Row-->
                                <!--begin::Row-->
                                <div class="row m-0">
                                    {{-- <div class="col bg-light-danger px-6 py-8 rounded-xl mr-7">
                                        ...
                                        <a href="#" class="text-danger font-weight-bold font-size-h6 mt-2">Itens nas ordens</a>
                                    </div> --}}
                                    <div class="col bg-light-success px-6 py-8 rounded-xl">
                                        ...
                                        <a href="#" class="text-success font-weight-bold font-size-h6 mt-2">Report de problemas</a>
                                    </div>
                                </div>
                                <!--end::Row-->
                            </div>
                        ...
                        <div class="card-body p-0">
                            <div class="d-flex align-items-center justify-content-between card-spacer flex-grow-1">
                                ...
                                <div class="d-flex flex-column text-right">
                                    ...
                                    <span class="text-muted font-weight-bold mt-2">Novos Usuários</span>
                                </div>
                            </div>
