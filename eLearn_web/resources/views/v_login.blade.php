				...
				<div class="d-flex flex-center bgi-size-cover bgi-no-repeat flex-row-fluid" style="background-image: url({{asset('metch')}}/media/bg/bg-1.jpg);">
					<div class="login-form text-center text-white p-7 position-relative overflow-hidden">
						...
						<div class="login-signin">
							<div class="mb-20">
								<h3>Acesso</h3>
								<p class="opacity-60 font-weight-bold">Entre com seus dados de login:</p>
							</div>
                            ...
                            <form method="POST" action="{{ route('login') }}">
								...
								<div class="form-group">
									<input class="form-control h-auto text-white placeholder-white opacity-70 bg-dark-o-70 rounded-pill border-0 py-4 px-8 mb-5" type="password" placeholder="Senha" name="password" id="password"/>
                                
								</div>

								<div class="form-group text-center mt-10">
									<button type="submit" class="btn btn-pill btn-outline-white font-weight-bold opacity-90 px-15 py-3">Entrar</button>
								</div>
							</form>

							{{-- <div class="mt-10">
								<span class="opacity-70 mr-4">Você ainda não tem uma conta?</span>
								<a href="javascript:;" id="kt_login_signup" class="text-white font-weight-bold">Assine!</a>
							</div> --}}
						</div>
